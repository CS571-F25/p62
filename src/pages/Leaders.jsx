...
const Leaders = () => {
  ...
  // Ensure the Instagram embed script runs after the component mounts and re-runs
  // the window.instgrm.Embeds.process() if the script is loaded.
  useEffect(() => {
        ...
        <Row>
          <Col>
            ...
            >
              <div style={{padding: '16px'}}> 
                <a 
                  href="https://www.instagram.com/p/DNf7mApNPs_/?utm_source=ig_embed&amp;utm_campaign=loading" 
                  style={{ 
                    background: '#FFFFFF', 
                    lineHeight: 0, 
                    padding: 0, 
                ...
                <p style={{ color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>
                  <a 
                    ...
                    target="_blank"
                  >
                    Meet our Chapter Shepherd Team! (@aaivuwmadison)
                  </a>
                </p>
              </div>
            </blockquote>
          ...
          <Col>
            ...
            >
              <div style={{padding: '16px'}}> 
                <a 
                  href="https://www.instagram.com/p/DOWAXCqDel7/?utm_source=ig_embed&amp;utm_campaign=loading" 
                  style={{ 
                    background: '#FFFFFF', 
                    lineHeight: 0, 
                    padding: 0, 
                ...
                <p style={{ color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>
                  <a 
                    ...
                    target="_blank"
                  >
                    Meet our Small Group Leaders! (@aaivuwmadison)
                  </a>
                </p>
              </div>
            </blockquote>
